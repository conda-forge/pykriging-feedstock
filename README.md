About pykriging-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pykriging-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5477&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pykriging-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pykriging` can be installed with `conda`:
...
```
mamba install pykriging
```

It is possible to list all of the versions of `pykriging` available on your platform with `conda`:
...
```
mamba search pykriging --channel conda-forge
```
...
mamba repoquery search pykriging --channel conda-forge

# List packages depending on `pykriging`:
mamba repoquery whoneeds pykriging --channel conda-forge

# List dependencies of `pykriging`:
mamba repoquery depends pykriging --channel conda-forge
```
